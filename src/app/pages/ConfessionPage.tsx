...
export default function ConfessionPage() {
  ...
  const incrementTabSwitch = useReflectionStore(state => state.incrementTabSwitch);
  ...
  const dynamicTheme = crime && crime.themeColors ? css`
  ...
  return (
    <div css={[containerStyle, dynamicTheme]}>
      ...
      <PeriodModal isOpen={isPeriodModalOpen} onClose={() => setIsPeriodModalOpen(false)} />
